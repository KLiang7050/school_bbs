...
<script>
import { listProvince, getProvince, delProvince, addProvince, updateProvince } from "@/api/bbs/user/province";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除省份字典表编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('app/province/export', {
        ...this.queryParams
