<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="主贴id" prop="mainId">
        <el-input
    ...
    <el-table v-loading="loading" :data="likeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="主贴id" align="center" prop="mainId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="主贴id" prop="mainId">
          <el-input v-model="form.mainId" placeholder="请输入主贴id" />
        </el-form-item>
      </el-form>
...
<script>
import { listLike, getLike, delLike, addLike, updateLike } from "@/api/bbs/like/like";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除点赞用户关联编号为"' + ids + '"的数据项？').then(function() {
        return delLike(ids);
      }).then(() => {
        this.getList();
